...
csv_path = 'C:/Users/roxan/OneDrive - The University of Western Ontario/ITSC/driver_19/Weighted/Third/all_samples_with_final_labels.csv'
data = pd.read_csv(csv_path)

# Specify the number of frames with the lowest confidence scores you want to list
n = 1000  # You can change this number
...
output_csv_path = 'C:/Users/roxan/OneDrive - The University of Western Ontario/ITSC/driver_19/Weighted/Third/lowest_confidence_iter_1.csv'
