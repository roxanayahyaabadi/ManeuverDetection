...
# Load the CSV file
file_path = 'C:/Users/roxan/OneDrive - The University of Western Ontario/ITSC/driver_19/XGBoost/Fourth/feature_vector_iter4.csv'
...
# Convert labels to a numeric encoding if they're not already
...
# Manually calculate class weights for handling class imbalance
class_weights = labeled_data['maneuver_type_encoded'].value_counts(normalize=True)
weights = y_train.map(lambda x: 1 / class_weights[x])

# Initialize and train the XGBoost model with calculated weights
...
combined_data['Final_Maneuver_Type'] = combined_data.apply(
    ...
    else label_encoder.inverse_transform([int(x['smoothed_label'])])[0], axis=1)

## Save CSV files
# output_folder = 'C:/Users/roxan/OneDrive - The University of Western Ontario/ITSC/Code/Windowing/driver_17/Third_iteration/'
output_folder = 'C:/Users/roxan/OneDrive - The University of Western Ontario/ITSC/driver_19/XGBoost/Fourth/'
